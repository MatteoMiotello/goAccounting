...
func (r *userR) GetAssets() AssetSlice {
	if r == nil {
		return nil
	}
	return r.Assets
...
var (
	userAllColumns            = []string{"id", "username", "email", "password", "deleted_at", "updated_at", "created_at"}
	userColumnsWithoutDefault = []string{"username", "email", "password"}
	userColumnsWithDefault    = []string{"id", "deleted_at", "updated_at", "created_at"}
...
func (o *User) Assets(mods ...qm.QueryMod) assetQuery {
...
func (userL) LoadAssets(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		qm.From(`assets`),
		qm.WhereIn(`assets.user_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (o *User) AddAssetsG(ctx context.Context, insert bool, related ...*Asset) error {
...
// Appends related to o.R.Assets.
// Sets related.R.User appropriately.
func (o *User) AddAssets(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Asset) error {
	var err error
